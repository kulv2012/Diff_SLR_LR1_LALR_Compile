...
#define GRAMMER_FILE  	".\\Grammar Analyze\\Grammar\\Test_SRLid.txt"
...
void GrammerAnalyzer::PrintClosureItem(ClosureItem * closureItem  )
{
...
void GrammerAnalyzer::PrintClosureItem( vector<ClosureItem>::const_iterator clusureIt  )
{
	//static NoneTermItem * lastterm = NULL ;
